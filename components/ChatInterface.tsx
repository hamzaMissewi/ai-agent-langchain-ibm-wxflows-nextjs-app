        ...
        <main className="flex flex-col h-[calc(100vh-theme(spacing.14))]">
            ...
            <section className="flex-1 overflow-y-auto bg-gray-50 p-2 md:p-0">
                <div className="max-w-4xl mx-auto p-4 space-y-3">
                    ...
                    {messages?.map((message: Doc<"messages">, index) => (
                        <MessageBubble
                            key={message._id}
                            content={message.content}
                            isUser={message.role === "user"}
                            sources={sourcesForMessages[(sourcesForMessages.length - 1 - index).toString()]}
                        />
                    ))}
                    ...
                    {isLoading && !streamedResponse && (
                        <div className="flex justify-start animate-in fade-in-0">
                            <div
                                className="rounded-2xl px-4 py-3 bg-white text-gray-900 rounded-bl-none shadow-sm ring-1 ring-inset ring-gray-200">
